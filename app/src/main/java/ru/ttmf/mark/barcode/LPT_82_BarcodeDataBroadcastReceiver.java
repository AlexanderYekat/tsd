...
public class LPT_82_BarcodeDataBroadcastReceiver extends BroadcastReceiver {

    public OnDecodeCompleteListener listener;

    public LPT_82_BarcodeDataBroadcastReceiver(OnDecodeCompleteListener listener){
