...
public class sgtin_scan_activity extends ScanActivity implements Observer<Response> {
    ...
    private sgtin_scan_activity_model viewModel;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_scan_sgtin_test_tabs);
        ButterKnife.bind(this);
        initToolbar(toolbar2, getString(R.string.scan_name));
        viewModel = ViewModelProviders.of(this)
                .get(sgtin_scan_activity_model.class);
    ...
    private void successfulScan(String code)
    {
        ...
        try {
            ...
            Toast toast;
                    ...
                    {
                        if (var.cisInfo.cis.equals(matrix.Cis()) || var.cisInfo.cis.equals(matrix.getSSCC())) // Проверка, был ли код отсканирован ранее
                        {
                    ...
                    if (!find) {
                        ...
                        if (matrix.SSCC()!=null)
                        {
                            ...
                            viewModel.getCisInfo(new requestdata(PreferenceController.getInstance().getOwnerId(), matrix.Cis())).observe(this,this);
                        }
                    }
        } catch (Exception ex) {
    ...
    {
        requestdata request = new requestdata(332);
